...
# Unit tests for SwaggerClient::BuildResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuildResource' do
  before do
    # run before each test
    @instance = SwaggerClient::BuildResource.new
  end
  ...
  describe 'test an instance of BuildResource' do
    it 'should create an instact of BuildResource' do
      expect(@instance).to be_instance_of(SwaggerClient::BuildResource)
    end
  end
