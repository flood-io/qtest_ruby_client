...
module SwaggerClient
  ...
  class TestCasePermission
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'edit_assignment')
        self.edit_assignment = attributes[:'edit_assignment']
      else
        self.edit_assignment = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          delete == o.delete &&
          view == o.view &&
          edit_assignment == o.edit_assignment &&
          export == o.export &&
          import == o.import &&
          approve == o.approve
    end
    ...
    def hash
      [create, edit, delete, view, edit_assignment, export, import, approve].hash
    end
