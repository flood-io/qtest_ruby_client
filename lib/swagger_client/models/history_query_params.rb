...
module SwaggerClient
  ...
  class HistoryQueryParams
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'object_query')
        self.object_query = attributes[:'object_query']
      end
    ...
    def hash
      [object_type, fields, query, object_query].hash
    end
