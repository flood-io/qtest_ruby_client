...
module SwaggerClient
  ...
  class DefectResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'submitted_date')
      ...
      if attributes.has_key?(:'submitter_id')
        self.submitter_id = attributes[:'submitter_id']
      end

      if attributes.has_key?(:'last_modified_user_id')
        self.last_modified_user_id = attributes[:'last_modified_user_id']
      end
    ...
    def hash
      [links, properties, attachments, id, pid, submitted_date, last_modified_date, submitter_id, last_modified_user_id, web_url].hash
    end
