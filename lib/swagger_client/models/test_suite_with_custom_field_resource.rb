...
module SwaggerClient
  ...
  class TestSuiteWithCustomFieldResource
    ...
    def valid?
      parent_type_validator = EnumAttributeValidator.new('String', ["root", "release", "test-cycle"])
    ...
    def parent_type=(parent_type)
      validator = EnumAttributeValidator.new('String', ["root", "release", "test-cycle"])
    ...
    def hash
      [parent_id, parent_type, links, id, name, order, pid, created_date, last_modified_date, properties, web_url, target_release_id, target_build_id].hash
    end
