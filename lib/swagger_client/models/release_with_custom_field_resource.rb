...
module SwaggerClient
  ...
  class ReleaseWithCustomFieldResource
    attr_accessor :links
    ...
    def hash
      [links, id, name, order, pid, created_date, last_modified_date, properties, web_url, description, note, start_date, end_date].hash
    end
