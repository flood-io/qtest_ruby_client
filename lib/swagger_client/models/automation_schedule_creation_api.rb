...
module SwaggerClient
  ...
  class AutomationScheduleCreationAPI
    ...
    def self.swagger_types
      {
        ...
        :'creator' => :'Integer',
        :'project_id' => :'Integer',
        :'test_run_ids' => :'Array<Integer>',
        :'dynamic' => :'Hash<String, String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'testRunIds')
        if (value = attributes[:'testRunIds']).is_a?(Array)
          self.test_run_ids = value
        end
      end

      if attributes.has_key?(:'dynamic')
        if (value = attributes[:'dynamic']).is_a?(Array)
          self.dynamic = value
        end
      end
    ...
    def hash
      [client_id, name, agent_id, start_date, creator, project_id, test_run_ids, dynamic].hash
    end
