...
module SwaggerClient
  ...
  class AutomationTestLogResource
    attr_accessor :links
    ...
    attr_accessor :automation_content
    ...
    def self.swagger_types
      {
        ...
        :'status' => :'String',
        :'order' => :'Integer',
        :'test_step_logs' => :'Array<AutomationTestStepLog>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'module_names')
        if (value = attributes[:'module_names']).is_a?(Array)
          self.module_names = value
        end
      end
      ...
      if attributes.has_key?(:'automation_content')
        self.automation_content = attributes[:'automation_content']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          module_names == o.module_names &&
          agent_ids == o.agent_ids &&
          automation_content == o.automation_content
    end
    ...
    def hash
      [links, id, test_case_version_id, exe_start_date, exe_end_date, note, attachments, name, planned_exe_time, actual_exe_time, build_number, build_url, properties, system_name, status, order, test_step_logs, module_names, agent_ids, automation_content].hash
    end
