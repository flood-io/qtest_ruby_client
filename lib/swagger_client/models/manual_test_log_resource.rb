...
module SwaggerClient
  ...
  class ManualTestLogResource
    ...
    def hash
      [links, id, test_case_version_id, exe_start_date, exe_end_date, note, attachments, name, planned_exe_time, actual_exe_time, build_number, build_url, properties, status, result_number, test_step_logs, defects].hash
    end
