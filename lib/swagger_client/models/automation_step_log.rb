...
module SwaggerClient
  ...
  class AutomationStepLog
    ...
    def list_invalid_properties
      ...
      if @test_step_log_id.nil?
        invalid_properties.push("invalid value for 'test_step_log_id', test_step_log_id cannot be nil.")
      end
    ...
    def valid?
      return false if @test_step_log_id.nil?
      return true
    end
    ...
    def hash
      [test_step_log_id, actual_result, status].hash
    end
